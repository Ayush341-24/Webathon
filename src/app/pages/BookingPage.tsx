  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const bookingData = {
        ...
        location: {
          lat: 12.9716, // Mock coordinates for now (Bangalore)
          lng: 77.5946,
          address: address
        },
        scheduledTime: bookingTime === "now" ? new Date() : new Date(Date.now() + 86400000), // +1 day
          ...
          >
                ...
                {bookingTime === "later" && (
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => {
                        // You could store this in a separate state if needed, e.g. setScheduledDate(e.target.value)
                        // For now we just let the start time flow
                      }}
                    />
                  </motion.div>
                )}
            ...
            <div className="mb-8">
              ...
              <div className="relative flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-input-background border-2 border-border rounded-xl focus:border-primary focus:outline-none transition-colors text-foreground placeholder-muted-foreground"
                  />
                </div>
                <button
                  type="button"
                  ...
                  className="px-4 py-2 bg-secondary text-secondary-foreground rounded-xl border border-border hover:bg-secondary/80 transition-colors flex items-center justify-center whitespace-nowrap"
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Helper will be assigned based on proximity to this location
              </p>
            </div>
